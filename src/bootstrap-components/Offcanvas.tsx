...
import { OffcanvasPlacement as PlacemntProps } from "react-bootstrap/esm/Offcanvas";

interface OffCanvasBackdropProps {
  name: string;
  props?: React.ComponentProps<typeof Offcanvas>;
  placement?: PlacemntProps;
}
...
const BSOffcanvas = () => {
  ...
  const OffCanvasPlacement: React.FC<OffCanvasBackdropProps> = ({
    name,
    placement,
    props,
  }) => {
  ...
  const OffCanvasBackdrop: React.FC<OffCanvasBackdropProps> = ({
    name,
    placement,
    props,
  }) => {
                ...
                <Tab.Content>
                  <Tab.Pane eventKey="all" className="pb-4 p-4">
                    ...
                    {["start", "end", "top", "bottom"].map((placement, idx) => (
                      <OffCanvasPlacement
                        key={idx}
                        placement={placement as PlacemntProps}
                        name={placement}
                      />
                    ))}
