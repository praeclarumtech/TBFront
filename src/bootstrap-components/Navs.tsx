        ...
        <Col xl={12} lg={12} md={12} sm={12} className="mt-4">
          <div className="mb-4">
            <p>
              ...
              respectively. This because it&apos;s possible (and common) to
              leave off the <code>&lt;Nav.Item&gt;</code>&apos;s and render a{" "}
          ...
          <div id="available-styles" className="mb-4">
            ...
            <div className="mt-4" id="horizontal-alignment">
              ...
              <p>
                ...
                making use of the{" "}
                <Link
                  to="https://getbootstrap.com/docs/4.0/layout/grid/#horizontal-alignment"
                  target="_blank"
                  rel="noreferrer"
                >
                  flexbox layout
      ...
      <Row>
        <Col xl={12} lg={12} md={12} sm={12}>
          <div id="pills" className="mb-4">
            <h3>Pills</h3>
            <p>
              An alternative visual with <code>variant=&#34;pills&#34;</code>{" "}
              prop
            </p>
          </div>
        ...
        <Col xl={12} lg={12} md={12} sm={12}>
          <div id="javascript-behavior" className="mb-4">
            ...
            <p>
              ...
              <Link
                to="https://www.w3.org/TR/wai-aria-practices/#tabpanel"
                target="_blank"
                rel="noreferrer"
              >
