      ...
      <Row>
        <Col xl={12} lg={12} md={12} sm={12}>
          <div className="mb-4 mt-4">
            <p>
              Use <code>variant=&#34;dark&#34; </code>to invert the colors of
              the table and get light text on a dark background.
            </p>
          </div>
      ...
      <Row>
        <Col xl={12} lg={12} md={12} sm={12}>
          <div id="responsive-tables" className="mb-4">
            ...
            <p>
              Use <code>responsive=&#34;sm&#34;</code>,{" "}
              <code>responsive=&#34;md&#34;</code>,{" "}
              <code>responsive=&#34;lg&#34;</code>, or{" "}
              <code>responsive=&#34;xl&#34;</code> as needed to create
              responsive tables up to a particular breakpoint. From that
