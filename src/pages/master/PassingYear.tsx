...
const PassingYear = () => {
  ...
  const handleUpdateYear = async (_id: never, newYear: number) => {
    try {
                          ...
                          <tr key={item._id} className="">
                            ...
                            <td className="flex justify-center space-x-2 text-center">
                              <EditIcon
                                ...
                                className="mx-2"
                                onClick={() =>
                                  handleEditYear(item._id, item.year)
                                }
                                // className="px-4 py-1 !bg-blue-600 !hover:bg-primary !outline-none !text-white"
                              >
                                Edit
                              ...
                              <DeleteIcon
                                ...
                                // className="px-4 py-1 !bg-red-600 !hover:bg-denger !outline-none !text-white  "
                              >
                                Delete
                              </DeleteIcon>
                            </td>
