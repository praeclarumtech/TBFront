...
const Country = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      ...
      else if (countryToDelete._id) {
        const res = await deleteCountry({ _id: countryToDelete._id });
        if (res?.success) {
    ...
    () => [
      {
        header: (
          <input
            ...
            checked={
              selectedcountry.length === country.length && country.length > 0
            }
          />
        ),
        accessorKey: "select",
  ...
  const validation = useFormik({
    ...
    initialValues: {
      _id: editingCountry ? editingCountry._id : "",
      country_name: editingCountry ? editingCountry.country_name : "",
    },
              ...
              <CardBody>
                <Row className="flex">
                  ...
                  <BaseModal
                    ...
                    modalTitle={editingCountry ? "Edit Country" : "Add Country"}
                    submitButtonText={
                    ...
                    <Row className="inline-block d-flex">
                      <Col xs={12} md={8} lg={6}>
                        <BaseInput
                          ...
                          type="text"
                          placeholder={InputPlaceHolder("Country to be Added")}
                          handleChange={validation.handleChange}
                          handleBlur={validation.handleBlur}
                          value={validation.values.country_name}
                          touched={!!validation.touched.country_name}
                          error={
                            typeof validation.errors.country_name === "string"
                              ? validation.errors.country_name
                              : undefined
                          }
