...
const ClientApplications = () => {
  document.title = `Client Applications | ${projectTitle}`;
  ...
  const fetchDropdownOptions = async () => {
    ...
    try {
      ...
      if (isAdmin) {
        // Fetch clients (only admin can see client dropdown)
        ...
        if (isClient || isVendor) {
          ...
          try {
            ...
            const vendors =
              vendorsResponse?.data?.vendors || vendorsResponse?.data || [];
            setVendorOptions(
    ...
    () => [
      ...
      },
      {
        ...
        cell: ({ row }: any) => {
          ...
          if (!vendor || (!vendor.name && !vendor.company_name)) return "-";
          return (
            <div>
    ...
    <Fragment>
      ...
      >
        <div className="flex flex-col gap-4">
          ...
          {/* Client Dropdown - Show only for Admin */}
          {isAdmin && (
            <div>
          ...
          {/* Vendor Dropdown - Show for Admin, Client, and Vendor */}
