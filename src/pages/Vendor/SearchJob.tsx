...
//     if (filterJobDescription) params.job_description = filterJobDescription;
//     if (filterJobSubject) params.job_subject = filterJobSubject;
...
//         {/* Sticky Header */}
//         {/* <div className="sticky top-0 z-10 pb-3 bg-white border-b">
...
//       <Container fluid className="pb-4 pl-4 pr-4 mt-9 bg-light">
//         <Row className="pt-3">
//           <Col xs={12} sm={6} md={4} lg={3} className="sticky ">
//             <div className="sticky max-h-screen top-16">
//               <div className="bg-white rounded shadow">{drawerList()}</div>
//             </div>
//           </Col>

//           <Col xs={12} sm={6} md={8} lg={9}>
//             {/* This part stays scrollable */}
//             {loading ? (
//               <Skeleton count={5} />
//             ) : formData?.length > 0 ? (
...
//                   return (
//                     <Card className="p-4 border border-gray-200 rounded-md shadow">
//                       <CardBody>
