...
const ViewApplicantPage = () => {
  ...
  const detailsBlock = useMemo(() => {
      ...
      >
        <Row gutter={[16, 16]}>
          <Col span={12}>
            ...
            <DetailsRow
              label="Gender"
              value={formData.gender ? capitalizeWords(formData.gender) : "-"}
            />
            <DetailsRow
          ...
          <Col span={12}>
            ...
            <DetailsRow
              label="Country"
              value={formData.country ? capitalizeWords(formData.country) : "-"}
            />
            <DetailsRow
    ...
    const jobOfferLeftRoleInner = (
      <>
        ...
        <DetailsRow
          label="Designation"
          value={
            <Tag color="blue">{formData.currentCompanyDesignation || "-"}</Tag>
          }
        />
        <DetailsRow
    ...
    const jobOfferLeftSkillsInner = (
      <>
        ...
        <DetailsRow
          ...
          value={(() => {
            const tokens = parseWorkPreferenceTokens(formData.workPreference);
          ...
          value={
            formData.otherSkills.length > 0 ? (
              <div className="flex flex-wrap gap-1">
                {formData.otherSkills.split(",").map((skill, index) => (
    ...
    const jobOfferRightMetricsInner = (
      <>
        ...
        <DetailsRow
          ...
          value={<Tag color="volcano">{`${formData.rating || "-"} / 10`}</Tag>}
        />
    ...
    return (
      <div className="w-full">
        <Row gutter={[24, 24]} className="w-full" align="top">
          <Col xs={24} xl={12}>
  ...
  useEffect(() => {
    if (searchParams.get("view-applicant") !== "view-applicant") {
      const next = new URLSearchParams(searchParams);
      next.set("view-applicant", "view-applicant");
  ...
  return (
    <div
      className="container-fluid w-100 py-4 px-3 px-lg-4"
      style={{
        maxWidth: "100%",
        width: "100%",
        margin: 0,
