...
const EditApplicant: React.FC<PreviewFormProps> = ({ data, onEdit, onSubmit }) => { 
  return (
    <div>
      <PersonalDetailsForm onNext={function (data: any): void {
              throw new Error('Function not implemented.')
          } } onCancel={function (): void {
              throw new Error('Function not implemented.')
          } } initialValues={undefined}/>
         
      <EducationalDetailsForm onNext={function (data: any): void {
              throw new Error('Function not implemented.')
          } } onBack={function (): void {
              throw new Error('Function not implemented.')
          } } initialValues={undefined}/>
      
      <JobDetailsForm onNext={function (data: any): void {
              throw new Error('Function not implemented.')
          } } onBack={function (): void {
              throw new Error('Function not implemented.')
          } } initialValues={undefined}/>
