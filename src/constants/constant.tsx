const appConstants = Object.freeze({
  ...
  designationType: [
    ...
    { label: "React.js Developer", value: "React.js Developer" },
    ...
    { label: "Web UI Engineer", value: "Web UI Engineer" },
    { label: "Frontend Architect", value: "Frontend Architect" },
    { label: "Senior Frontend Engineer", value: "Senior Frontend Engineer" },

    { label: "Backend Developer", value: "Backend Developer" },
    { label: "Node.js Developer", value: "Node.js Developer" },
    { label: "Python Backend Developer", value: "Python Backend Developer" },
    { label: "Java Backend Developer", value: "Java Backend Developer" },
    { label: "Golang Developer", value: "Golang Developer" },
    { label: "Ruby on Rails Developer", value: "Ruby on Rails Developer" },
    { label: "C# Backend Developer", value: "C# Backend Developer" },
    { label: "API Developer", value: "API Developer" },
    { label: "Backend Architect", value: "Backend Architect" },

    { label: "Full Stack Developer", value: "Full Stack Developer" },
    { label: "MERN Stack Developer", value: "MERN Stack Developer" },
    { label: "MEAN Stack Developer", value: "MEAN Stack Developer" },
    { label: "LAMP Stack Developer", value: "LAMP Stack Developer" },
    { label: "Java Full Stack Developer", value: "Java Full Stack Developer" },
    { label: ".NET Full Stack Developer", value: ".NET Full Stack Developer" },
    { label: "PHP Full Stack Developer", value: "PHP Full Stack Developer" },
    ...
    { label: "Mobile UI Developer", value: "Mobile UI Developer" },

    { label: "Cloud Developer", value: "Cloud Developer" },
    { label: "AWS Developer", value: "AWS Developer" },
    { label: "Azure Developer", value: "Azure Developer" },
    { label: "GCP Developer", value: "GCP Developer" },
    { label: "DevOps Engineer", value: "DevOps Engineer" },
    { label: "Cloud Native Developer", value: "Cloud Native Developer" },
    ...
    { label: "Big Data Developer", value: "Big Data Developer" },
    ...
    {
      label: "Embedded Software Developer",
      value: "Embedded Software Developer",
    },
    {
      label: "Systems Software Developer",
      value: "Systems Software Developer",
    },
    ...
    { label: "VR Developer", value: "VR Developer" },

    { label: "Web Developer", value: "Web Developer" },
    { label: "Web Application Developer", value: "Web Application Developer" },
    { label: "CMS Developer", value: "CMS Developer" },
    { label: "WordPress Developer", value: "WordPress Developer" },
    { label: "Drupal Developer", value: "Drupal Developer" },
    ...
    { label: "API Integration Developer", value: "API Integration Developer" },
    { label: "Automation Developer", value: "Automation Developer" },
    { label: "Chatbot Developer", value: "Chatbot Developer" },
    ...
    { label: "Frontend UI/UX Developer", value: "Frontend UI/UX Developer" },
    { label: "Interaction Developer", value: "Interaction Developer" },
  ...
  technologyOptions: {
    ...
    "Web Designer": ["Figma", "Photoshop", "HTML", "CSS"],
    ...
    "Junior MERN Stack Developer": ["React", "Nodejs", "MongoDB"],
    ...
    "Reactjs Developer": ["React", "Redux", "TypeScript", "Vite"],
    "React Native Developer": ["React Native", "Expo", "TypeScript"],
    "Nodejs Developer": ["Nodejs", "Express", "MongoDB"],
    ...
    "Associate Software Engineer": ["Java", "SQL", "Git"],
    "Associate Process Manager": ["JIRA", "Confluence", "Excel"],
    Freelancer: ["WordPress", "Elementor", "JavaScript", "HTML"],
    "Team Leader": ["JIRA", "Slack", "Git"],
    "Senior Angular Developer": ["Angular", "RxJS", "NgRx"],
    "SharePoint Developer": ["SharePoint", "Power Automate", "Power Apps"],
    "Placement executive": ["Excel", "CRM", "MS Office"],
    ...
    "Customer Support Specialist": ["Zendesk", "Intercom", "CRM"],
    Other: [],
  },
});
