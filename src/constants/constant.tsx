const appConstants = Object.freeze({
  ...
  technologyOptions: {
    ...
    "Senior PHP Developer": ["PHP", "Symfony", "MySQL", "JavaScript", "APIs"],
    ...
    "Laravel Developer": ["PHP", "Laravel", "MySQL", "Blade"],
    "Symfony Developer": ["PHP", "Symfony", "Doctrine", "Twig"],
    "CodeIgniter Developer": ["PHP", "CodeIgniter", "MySQL", "HTML"],
    "Drupal PHP Developer": ["PHP", "Drupal", "MySQL", "Twig"],
    "WordPress PHP Developer": ["PHP", "WordPress", "MySQL", "Elementor"],
    "Magento PHP Developer": ["PHP", "Magento", "MySQL", "Knockout.js"],

    "Junior LAMP Stack Developer": ["Linux", "Apache", "MySQL", "PHP"],
    "Associate LAMP Stack Developer": ["Linux", "Apache", "MySQL", "PHP"],
    "Senior LAMP Stack Developer": ["Linux", "Apache", "MySQL", "PHP"],

    "PHP Backend Developer": ["PHP", "Laravel", "MySQL", "REST APIs"],
    "PHP Web Developer": ["PHP", "JavaScript", "HTML", "CSS", "MySQL"],
    "PHP API Developer": ["PHP", "REST APIs", "Postman", "MySQL"],
    "Senior PHP API Developer": ["PHP", "RESTful APIs", "OAuth2", "MySQL"],

    "PHP Engineer": ["PHP", "MySQL", "Git", "Laravel"],
    "PHP Architect": ["PHP", "Architecture Patterns", "REST", "MySQL"],

    "PHP DevOps Engineer": ["PHP", "Docker", "CI/CD", "MySQL"],
    "PHP Software Engineer": ["PHP", "Laravel", "SQL", "OOP"],

    "Junior Software Engineer": ["Java", "JavaScript", "Git", "HTML"],
    "Associate Software Engineer": ["Java", "Python", "SQL", "Git"],
    ...
    "System Engineer": ["Linux", "Networking", "Python"],
    "Senior System Engineer": ["Cloud", "Linux", "Docker", "Monitoring Tools"],

    "Programmer Analyst": ["Java", "SQL", "Oracle"],
    "Specialist Programmer": ["Data Structures", "Algorithms", "Python"],

    "Junior Frontend Developer": ["HTML", "CSS", "JavaScript", "React"],
    "Associate Frontend Developer": ["React", "JavaScript", "TypeScript"],
    "Frontend Developer": [
      "React",
      "MUI",
      "TypeScript",
    ...
    "Senior Frontend Developer": ["React", "Redux", "TypeScript", "Webpack"],
    "Frontend Architect": ["React", "Architecture", "TypeScript"],

    "HTML/CSS Developer": ["HTML", "CSS", "JavaScript"],
    "JavaScript Developer": ["JavaScript", "ES6+", "Node.js", "React"],

    "Junior React.js Developer": ["React", "JavaScript", "HTML"],
    "Associate React.js Developer": ["React", "Redux", "JavaScript"],
    "React.js Developer": ["React", "Redux", "TypeScript", "Vite"],
    "Senior React.js Developer": ["React", "Hooks", "Redux", "TypeScript"],

    "Junior Angular Developer": ["Angular", "TypeScript", "HTML"],
    "Associate Angular Developer": ["Angular", "RxJS", "TypeScript"],
    "Angular Developer": ["Angular", "RxJS", "NgRx"],
    "Senior Angular Developer": ["Angular", "RxJS", "NgRx"],

    "Vue.js Developer": ["Vue.js", "Vuex", "JavaScript"],
    "UI Developer": ["HTML", "CSS", "JavaScript", "React"],
    "UI Engineer": ["React", "CSS-in-JS", "Storybook"],
    "UX Engineer": ["Figma", "User Research", "Prototyping"],
    "Web UI Engineer": ["React", "HTML", "CSS"],
    "Frontend UI/UX Developer": ["Figma", "React", "CSS", "JavaScript"],
    "Interaction Developer": ["JavaScript", "Animations", "HTML", "CSS"],

    "Junior Backend Developer": ["Node.js", "MongoDB", "Express"],
    "Associate Backend Developer": ["Node.js", "Express", "MongoDB"],
    "Backend Developer": [
      "Node.js",
      "Next.js",
      "Express",
    ...
    "Senior Backend Developer": ["Node.js", "NestJS", "PostgreSQL", "Docker"],
    "Backend Architect": [
      "Node.js",
      "Microservices",
      "Architecture",
    ...
    "Junior Node.js Developer": ["Node.js", "JavaScript", "MongoDB"],
    "Associate Node.js Developer": ["Node.js", "Express", "MongoDB"],
    "Node.js Developer": ["Node.js", "Express", "MongoDB"],
    "Senior Node.js Developer": ["Node.js", "TypeScript", "Docker"],

    "Junior Java Developer": ["Java", "Spring", "JSP"],
    "Associate Java Developer": ["Java", "Spring Boot", "SQL"],
    "Java Developer": ["Java", "Spring Boot", "Hibernate", "SQL", "Maven"],
    "Senior Java Developer": ["Java", "Spring Boot", "Microservices"],

    "Junior Python Developer": ["Python", "Flask", "SQL"],
    "Associate Python Developer": ["Python", "Django", "SQL"],
    "Python Developer": ["Python", "Django", "Flask", "SQL", "Git"],
    "Senior Python Developer": ["Python", "FastAPI", "Docker", "Pandas"],

    "Junior C# Backend Developer": ["C#", ".NET", "SQL"],
    "Associate C# Backend Developer": ["C#", ".NET Core", "SQL"],
    "C# Backend Developer": ["C#", ".NET Core", "SQL"],
    ...
    "Ruby on Rails Developer": ["Ruby", "Rails", "PostgreSQL", "RSpec"],
    "Golang Developer": ["Go", "gRPC", "PostgreSQL", "Docker"],
    "API Developer": ["REST APIs", "Postman", "Node.js", "Swagger"],
    ...
    "Associate Full Stack Developer": ["React", "Node.js", "MongoDB"],
    ...
    "Senior Full Stack Developer": ["React", "Node.js", "GraphQL", "Docker"],

    "Junior MERN Stack Developer": ["React", "Node.js", "MongoDB"],
    "Associate MERN Stack Developer": ["React", "Node.js", "MongoDB"],
    ...
    "Junior MEAN Stack Developer": ["Angular", "Node.js", "MongoDB"],
    "Associate MEAN Stack Developer": ["Angular", "Node.js", "MongoDB"],
    ...
    ".NET Full Stack Developer": [".NET", "C#", "React", "SQL"],

    "Junior DotNet Developer": ["C#", ".NET Core", "SQL"],
    "Associate DotNet Developer": ["C#", ".NET", "SQL"],
    "DotNet Developer": ["DotNET", "C#", "SQL", "JavaScript", "Angular"],
    "Senior DotNet Developer": ["C#", "ASP.NET", "Azure", "Entity Framework"],

    "React Native Developer": ["React Native", "Expo", "TypeScript"],
    "Flutter Developer": ["Flutter", "Dart", "Firebase"],
    "Android Developer": ["Kotlin", "Java", "Android SDK"],
    "iOS Developer": ["Swift", "Xcode", "UIKit"],
    "Mobile App Developer": ["React Native", "Flutter", "Firebase"],
    "Mobile UI Developer": ["Figma", "React Native", "Flutter"],
    "Xamarin Developer": ["C#", "Xamarin", "Visual Studio"],

    "Junior WooCommerce Developer": ["WooCommerce", "PHP", "WordPress"],
    "Associate WooCommerce Developer": ["WooCommerce", "PHP", "WordPress"],
    "WooCommerce Developer": ["WooCommerce", "PHP", "WordPress"],
    "Senior WooCommerce Developer": ["WooCommerce", "PHP", "WordPress"],
    ...
    "AI Developer": ["Python", "PyTorch", "TensorFlow"],
    "Big Data Developer": ["Hadoop", "Spark", "Hive"],
    "ETL Developer": ["SQL", "Informatica", "ETL Tools"],

    "DevOps Engineer": ["Docker", "Kubernetes", "Terraform", "AWS"],
    "Cloud Developer": ["AWS", "Azure", "Google Cloud"],
    "AWS Developer": ["AWS", "Lambda", "CloudFormation"],
    "Azure Developer": ["Azure", "DevOps", "Functions"],
    "GCP Developer": ["GCP", "BigQuery", "Pub/Sub"],
    "Cloud Native Developer": ["Docker", "Kubernetes", "Cloud APIs"],
    "Platform Engineer": ["CI/CD", "Monitoring", "Infrastructure"],

    "Game Developer": ["Unity", "C#", "Game Physics"],
    "Unity Developer": ["Unity", "C#", "Shader Graph"],
    "Unreal Engine Developer": ["C++", "Unreal Engine"],
    "AR Developer": ["ARKit", "Unity", "Vuforia"],
    "VR Developer": ["Unity", "Unreal", "Oculus"],

    "Web Developer": ["HTML", "CSS", "JavaScript", "PHP"],
    "Web Application Developer": ["React", "Node.js", "MongoDB"],
    "CMS Developer": ["WordPress", "Drupal", "Joomla"],
    "WordPress Developer": ["WordPress", "PHP", "Elementor"],
    "Drupal Developer": ["Drupal", "PHP", "Twig"],
    "Shopify Developer": ["Shopify", "Liquid", "JavaScript"],
    "Magento Developer": ["Magento", "PHP", "MySQL"],

    "Blockchain Developer": ["Solidity", "Ethereum", "Web3.js"],
    "SharePoint Developer": ["SharePoint", "Power Automate", "Power Apps"],
    "API Integration Developer": ["REST", "SOAP", "Postman"],
    "Automation Developer": ["Python", "Selenium", "AutoIt"],
    "Chatbot Developer": ["Dialogflow", "Botpress", "Node.js"],
    "ERP Developer": ["Odoo", "SAP", "ABAP"],
    "Salesforce Developer": ["Salesforce", "Apex", "Visualforce"],
    "CRM Developer": ["CRM Tools", "JavaScript", "SQL"],

    "Embedded Software Developer": ["C", "C++", "RTOS"],
    "Systems Software Developer": ["C", "C++", "Kernel"],

    "QA Engineer": ["Selenium", "Jest", "Mocha", "JUnit", "Cypress"],
    "Quality Analyst": ["TestRail", "Postman", "JIRA"],
    "Test Engineer": ["Selenium", "JUnit", "Bugzilla"],
    "Automation Test Engineer": ["Selenium", "Python", "Jenkins"],
    "Manual Test Engineer": ["Excel", "Test Cases", "Bug Reports"],
    "Software Test Engineer": ["Selenium", "Postman", "JIRA"],
    "Test Lead": ["Test Planning", "Selenium", "Team Mgmt"],
    "Test Architect": ["Framework Design", "Automation Tools"],
    "QA Automation Engineer": ["Cypress", "Selenium", "JavaScript"],
    "Performance Test Engineer": ["JMeter", "LoadRunner", "Monitoring Tools"],
    "Security Test Engineer": ["Burp Suite", "OWASP ZAP", "Nmap"],

    Fresher: ["HTML", "CSS", "Git"],
    Other: [],
  },
});
