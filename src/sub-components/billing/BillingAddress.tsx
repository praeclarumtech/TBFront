...
const BillingAddress = () => {
  ...
  const NewBillingAddressModal = ({ props }: any) => {
    return (
      <Modal
        {...props}
        size="lg"
          ...
          <Card.Body>
            <Row className="align-items-center">
                ...
                <div className="mb-3 mb-lg-0">
                  <Form.Check id="shippingBillingAddress1">
                    ...
                    <Form.Check.Label>
                      ...
                      <span className="d-block text-dark fw-medium fs-4">
                        Valarie Tarrant
                      </span>
                      <span className="d-block mb-4">
                        3757 Morgan Street Tallahassee, FL 32301
                      </span>
                      <Link to="#" className="me-2 link-success">
                        Edit
                      </Link>
              ...
              >
                <div className="mb-2">
                  <p className="mb-1">
                    E-mail: <Link to="#">valarietarrant@dashui.com</Link>
                  </p>
              ...
              <Col lg={6} md={12} xs={12} className="mb-4 mb-lg-0">
                <Form.Check id="shippingBillingAddress2">
                  ...
                  <Form.Check.Label>
                    ...
                    <Link to="#" className="me-2 text-muted text-primary-hover">
                      Set as Default
                    </Link>
                  </Form.Check.Label>
                </Form.Check>
